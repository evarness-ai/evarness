...
for var in ("EVARNESS_PROMPTS", "EVARNESS_TOOLS", "EVARNESS_TIERS",
            "EVARNESS_PROVIDERS", "EVARNESS_INVARIANTS", "EVARNESS_GROUNDING",
            "EVARNESS_CLASSIFICATION", "EVARNESS_EXPORTERS", "EVARNESS_JUDGES"):
